...
const BRIEFINGS = [
  ...
  },
  {
    ...
    desc: '닥터저지가 처음이신 분들, 환영합니다',
    cta: '사용법 보기',
    href: './guide.html',
  },
  {
    id: 'b-points',
    title: '닥터저지 공유하고 포인트도 받자!',
    desc: 'AI 판정 카드를 공유하면 포인트를 드립니다',
    cta: '포인트 받는 방법',
...
const RESULT_SAMPLE = {
  ...
  caution:
    '이 서비스는 의료 진단·처방을 대체하지 않습니다. 증상이 있다면 전문가와 상담하세요.',
};
...
const BUY_CRITERIA = [
  ...
  },
  {
    ...
    items: [
      [
        '피부 타입과 민감도',
        '본인의 피부 상태와 성분 알레르기를 고려해 선택하세요',
      ],
      ['성분 확인', '자극 성분 배제와 유효 성분 함유 여부를 점검하세요'],
      [
        '제품 평가 및 후기',
        '객관적인 피부 반응 데이터를 참고하는 것이 도움됩니다',
      ],
    ],
  },
];
